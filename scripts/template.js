...
function itemTemplate(index){
    ...
    <img src="./assets/icons/delete.svg" class="delete" onclick="removeItem(${index})">
...
function pizzaTemplate(index){
    return ` <section id="pizza_template_section">
    <div class="food_card">
    <div class="food_info">
        <img src="./assets/img/${foods[index].img}" class="food_img">
        <div>
        ...
        <div class="buy_area">
        <p>${foods[index].price.toFixed(2) + "€"}</p>
        <button class="buy" onclick="addtoBasket(${[index]})">Add to basket</button>
    </div>
    </div>
</section>
    `
